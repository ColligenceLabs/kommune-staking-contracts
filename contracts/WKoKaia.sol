...
//    OwnableUpgradeable
{
    ...
    event Wrap(address, uint256, uint256);
    event Unwrap(address, uint256, uint256);
        ...
        validAddress(stKlayAddress)
    {
        ...
        __KIP7_init_unchained("Kommune Wrapped KoKAIA", "wKoKAIA");
//        __Ownable_init_unchained();
        ...
        returns (uint256 wrappedAmount)
    {
        ...
        emit Wrap(_msgSender(), amount, wrappedAmount);
    }
        ...
        returns (uint256 unwrappedAmount)
    {
        ...
        emit Unwrap(_msgSender(), amount, unwrappedAmount);
    }
    ...
    function getWrappedAmount(uint256 amount)
        ...
        returns (uint256 wrappedAmount)
    {
        wrappedAmount = stKlay.protectedGetSharesByKlay(amount) / 10**9;
    }
